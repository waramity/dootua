    ...
    if request.method == 'POST' and form.validate_on_submit():
        ...
        for file in profile_image_files:
            if file.filename != "":
                ...
                profile_image = ProfileImage(name=file.filename, data=data, rendered_data=render_file, user_id=current_user.id, uploaded_date=datetime.datetime.now(pytz.timezone('UTC')))
